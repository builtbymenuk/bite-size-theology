...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    story: Schema.Attribute.Component<'shared.text-item', true>;
    turnImage: Schema.Attribute.Media<'images'>;
    turnLead: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiAllThingAllThing extends Struct.SingleTypeSchema {
  collectionName: 'all_things';
  info: {
    displayName: 'Homepage \u2014 4. All the Things';
    pluralName: 'all-things';
    singularName: 'all-thing';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCallingCalling extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Homepage \u2014 3. The Calling';
    pluralName: 'callings';
    singularName: 'calling';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    body: Schema.Attribute.Component<'shared.text-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    rootedBody: Schema.Attribute.Text;
    rootedTitle: Schema.Attribute.String;
...
export interface ApiCollectionCollection extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Homepage \u2014 5. The Collection';
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    connectLabel: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    fieldSubject: Schema.Attribute.String;
    formHeading: Schema.Attribute.String;
    formSubheading: Schema.Attribute.String;
    formSubmit: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    mailingLabel: Schema.Attribute.String;
    mailingLines: Schema.Attribute.Component<'shared.text-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    socials: Schema.Attribute.Component<'shared.social', true>;
    subjectOptions: Schema.Attribute.Component<'shared.text-item', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEyebrowEyebrow extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Homepage \u2014 2. Eyebrow Strip';
    pluralName: 'eyebrows';
    singularName: 'eyebrow';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    messageBody: Schema.Attribute.Text;
    messageLead: Schema.Attribute.String;
    messageWord: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wordmark: Schema.Attribute.String;
  };
}
...
export interface ApiPodcastPagePodcastPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ctaHeadingLead: Schema.Attribute.String;
    ctaPills: Schema.Attribute.Component<'shared.text-item', true>;
    heroHeading: Schema.Attribute.String;
...
export interface ApiPodcastPodcast extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Homepage \u2014 6. Podcast Promo';
    pluralName: 'podcasts';
  ...
  attributes: {
    actions: Schema.Attribute.Component<'shared.podcast-action', true>;
    badgeCategory: Schema.Attribute.String;
    badgeRank: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    episodes: Schema.Attribute.Component<'shared.episode', true>;
    eyebrow: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTourTour extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tour.tour'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    regions: Schema.Attribute.Component<'shared.tour-region', true>;
    secondPhoto: Schema.Attribute.Media<'images'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
